...
context_window = as_int(
    model_record.get("contextWindow", model_record.get("context_window")), 32768
)
max_tokens = as_int(model_record.get("maxTokens", model_record.get("max_tokens")), 8192)
...
print(f"[bootstrap-omp] wrote {agent_dir / 'config.yml'}")
print(f"[bootstrap-omp] wrote {agent_dir / 'models.yml'}")
print(f"[bootstrap-omp] model {selector}")
PY
