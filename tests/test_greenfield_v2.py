    ...
    def test_tool_collection_deduplication_is_ok_coverage(self) -> None:
        ...
        with tempfile.TemporaryDirectory(dir=ROOT / ".harness") as tmp:
            ...
            for tool, artifact, receipt in (("wraith", "sca-advisories.json", "wraith-receipt.json"), ("poltergeist", "secrets-redacted.json", "poltergeist-receipt.json")):
                ...
                write(scan / "tool-collection" / receipt, {"schema_version": "2.0", "tool": tool, "operation": "fixture", "status": "ok", "version": "fixture", "started_at": "now", "completed_at": "now", "parse_status": "ok", "result_count": 0, "normalized_sha256": digest, "warnings": []})
...
class GreenfieldContractTests(unittest.TestCase):
    ...
    def test_zero_campaign_whole_scan_is_valid(self) -> None:
        ...
        with tempfile.TemporaryDirectory(dir=ROOT / "scans") as tmp:
            ...
            sca={"schema_version":"2.0","tool":"wraith","packages_scanned":0,"advisory_count":0,"advisories":[]};secrets={"schema_version":"2.0","tool":"poltergeist","match_count":0,"candidate_count":0,"candidates":[]};write(scan/"tool-collection/sca-advisories.json",sca);write(scan/"tool-collection/secrets-redacted.json",secrets)
